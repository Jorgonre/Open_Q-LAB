...
circuit.append(cirq.CNOT(q[6], q[8]))
circuit.append(cirq.CZ(q[0], q[1]))
circuit.append(cirq.CZ(q[0], q[2]))
circuit.append(cirq.CZ(q[3], q[4]))
circuit.append(cirq.CZ(q[3], q[5]))
circuit.append(cirq.CZ(q[6], q[7]))
circuit.append(cirq.CZ(q[6], q[8]), strategy=cirq.InsertStrategy.NEW)

circuit.append(cirq.H(q[9]))
circuit.append(cirq.CNOT(q[9], q[10]), strategy=cirq.InsertStrategy.NEW)

circuit.append(cirq.CNOT(q[0], q[9]))

circuit.append(cirq.H(q[0]))
circuit.append(cirq.CNOT(q[9], q[10]))

circuit.append(cirq.CZ(q[0], q[10]), strategy=cirq.InsertStrategy.NEW)

circuit.append(cirq.CNOT(q[10], q[1]))
circuit.append(cirq.CNOT(q[10], q[2]))
circuit.append(cirq.CNOT(q[3], q[4]))
circuit.append(cirq.CNOT(q[3], q[5]))
circuit.append(cirq.CNOT(q[6], q[7]))
circuit.append(cirq.CNOT(q[6], q[8]))
circuit.append(cirq.CZ(q[10], q[1]))
circuit.append(cirq.CZ(q[10], q[2]))
circuit.append(cirq.CZ(q[3], q[4]))
circuit.append(cirq.CZ(q[3], q[5]))
circuit.append(cirq.CZ(q[6], q[7]))
circuit.append(cirq.CZ(q[6], q[8]))

circuit.append(cirq.CCNOT(q[1], q[2], q[10]))
circuit.append(cirq.CCNOT(q[5], q[4], q[3]))
circuit.append(cirq.CCNOT(q[8], q[7], q[6]), strategy=cirq.InsertStrategy.NEW)

circuit.append(cirq.H(q[10]))
circuit.append(cirq.CCNOT(q[1], q[2], q[10]))
circuit.append(cirq.H(q[10]))
circuit.append(cirq.H(q[3]))
circuit.append(cirq.CCNOT(q[5], q[4], q[3]))
circuit.append(cirq.H(q[3]))
circuit.append(cirq.H(q[6]))
circuit.append(cirq.CCNOT(q[8], q[7], q[6]))
circuit.append(cirq.H(q[6]), strategy=cirq.InsertStrategy.NEW)

circuit.append(cirq.H(q[10]))
circuit.append(cirq.H(q[3]))
circuit.append(cirq.H(q[6]))
circuit.append(cirq.Z(q[10]))
circuit.append(cirq.Z(q[3]))
circuit.append(cirq.Z(q[6]))
circuit.append(cirq.CNOT(q[10], q[3]))
circuit.append(cirq.CNOT(q[10], q[6]))
circuit.append(cirq.CZ(q[10], q[3]))
circuit.append(cirq.CZ(q[10], q[6]))
circuit.append(cirq.H(q[10]))
circuit.append(cirq.CCNOT(q[3], q[6], q[10]))
circuit.append(cirq.H(q[10]))
circuit.append(cirq.CCNOT(q[3], q[6], q[10]), strategy=cirq.InsertStrategy.NEW)
