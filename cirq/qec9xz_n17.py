...
qreg_q0 = cirq.NamedQubit.range(9, prefix='q0')     
...
circuit.append(cirq.CNOT(qreg_q0[0],qreg_q0[3]))
circuit.append(cirq.CNOT(qreg_q0[0],qreg_q0[6]))
circuit.append(cirq.H(qreg_q0[0]))
circuit.append(cirq.H(qreg_q0[3]))
circuit.append(cirq.H(qreg_q0[6]))
circuit.append(cirq.CNOT(qreg_q0[0],qreg_q0[1]))
circuit.append(cirq.CNOT(qreg_q0[0],qreg_q0[2]))
circuit.append(cirq.CNOT(qreg_q0[3],qreg_q0[4]))
circuit.append(cirq.CNOT(qreg_q0[3],qreg_q0[5]))
circuit.append(cirq.CNOT(qreg_q0[6],qreg_q0[7]))
circuit.append(cirq.CNOT(qreg_q0[6],qreg_q0[8]))
circuit.append(cirq.CNOT(qreg_q0[0],qreg_q1[0]))
circuit.append(cirq.CNOT(qreg_q0[1],qreg_q1[0]))
circuit.append(cirq.CNOT(qreg_q0[1],qreg_q1[1]))
circuit.append(cirq.CNOT(qreg_q0[2],qreg_q1[1]))
circuit.append(cirq.CNOT(qreg_q0[3],qreg_q1[2]))
circuit.append(cirq.CNOT(qreg_q0[4],qreg_q1[2]))
circuit.append(cirq.CNOT(qreg_q0[4],qreg_q1[3]))
circuit.append(cirq.CNOT(qreg_q0[5],qreg_q1[3]))
circuit.append(cirq.CNOT(qreg_q0[6],qreg_q1[4]))
circuit.append(cirq.CNOT(qreg_q0[7],qreg_q1[4]))
circuit.append(cirq.CNOT(qreg_q0[7],qreg_q1[5]))
circuit.append(cirq.CNOT(qreg_q0[8],qreg_q1[5]))
circuit.append(cirq.measure(qreg_q1[0], key="m0"))
circuit.append(cirq.measure(qreg_q1[1], key="m1"))
circuit.append(cirq.measure(qreg_q1[2], key="m2"))
circuit.append(cirq.measure(qreg_q1[3], key="m3"))
circuit.append(cirq.measure(qreg_q1[4], key="m4"))
circuit.append(cirq.measure(qreg_q1[5], key="m5"))
circuit.append(cirq.H(qreg_q0[0]))
circuit.append(cirq.H(qreg_q0[1]))
circuit.append(cirq.H(qreg_q0[2]))
circuit.append(cirq.H(qreg_q0[3]))
circuit.append(cirq.H(qreg_q0[4]))
circuit.append(cirq.H(qreg_q0[5]))
circuit.append(cirq.H(qreg_q0[6]))
circuit.append(cirq.H(qreg_q0[7]))
circuit.append(cirq.H(qreg_q0[8]))
circuit.append(cirq.CNOT(qreg_q0[0],qreg_q1[6]))
circuit.append(cirq.CNOT(qreg_q0[3],qreg_q1[7]))
circuit.append(cirq.CNOT(qreg_q0[1],qreg_q1[6]))
circuit.append(cirq.CNOT(qreg_q0[4],qreg_q1[7]))
circuit.append(cirq.CNOT(qreg_q0[2],qreg_q1[6]))
circuit.append(cirq.CNOT(qreg_q0[5],qreg_q1[7]))
circuit.append(cirq.CNOT(qreg_q0[3],qreg_q1[6]))
circuit.append(cirq.CNOT(qreg_q0[6],qreg_q1[7]))
circuit.append(cirq.CNOT(qreg_q0[4],qreg_q1[6]))
circuit.append(cirq.CNOT(qreg_q0[7],qreg_q1[7]))
circuit.append(cirq.CNOT(qreg_q0[5],qreg_q1[6]))
circuit.append(cirq.CNOT(qreg_q0[8],qreg_q1[7]))
circuit.append(cirq.measure(qreg_q1[6], key="m6"))
circuit.append(cirq.measure(qreg_q1[7], key="m7"))
circuit.append(cirq.H(qreg_q0[0]))
circuit.append(cirq.H(qreg_q0[1]))
circuit.append(cirq.H(qreg_q0[2]))
circuit.append(cirq.H(qreg_q0[3]))
...
for i in range(1024):
    ...
    s = str(int(m0[i])) + str(int(m1[i])) + str(int(m2[i])) + str(int(m3[i])) + str(int(m4[i])) + str(int(m5[i])) + str(int(m6[i])) + str(int(m7[i]))
    bitstrings.append(s)
...
num_1q = -8 #No contamos las measurements gates
num_2q = 0
