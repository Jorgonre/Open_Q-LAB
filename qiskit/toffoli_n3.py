...
circuit = QuantumCircuit(qreg_a, creg_c)
...
circuit.tdg(qreg_a[2])

circuit.cx(qreg_a[0], qreg_a[2])
...
circuit.measure(qreg_a[0], creg_c[0])
circuit.measure(qreg_a[1], creg_c[1])
circuit.measure(qreg_a[2], creg_c[2])
